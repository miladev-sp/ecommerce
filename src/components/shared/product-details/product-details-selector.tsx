  ...
  return (
    <div>
      <div>
        ...
        <div className="mt-3">
          <p className="font-satoshi text-[14px]  text-[#00000099] xl:text-[16px]">
            Select Colors
          </p>
        ...
        <div className="mt-3">
          ...
          <div className="mt-2.5 flex gap-1.5">
            {PRODUCT_SIZES.map((size) => (
              <button
                type="button"
                className={`bg-[#F0F0F0] rounded-[62px] w-18.5 h-9.75 font-satoshi  text-[14px] text-[#00000099] cursor-pointer ${selectedSize === size ? `bg-black text-white font-medium` : ""} xl:text-[16px] xl:w-26 xl:h-11.5`}
                key={size}
      ...
      <div>
        ...
        {cartItems.find(
          ...
          <div className="mt-4 flex gap-3 xl:gap-4">
            ...
            <button
              className="flex-2 bg-black text-white py-4 px-12 rounded-[62px] font-satoshi  xl:text-[16px] prevent-select cursor-pointer flex justify-center"
